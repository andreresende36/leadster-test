    ...
    <section className="bg-[#F0F8FF] h-[735px] w-[100%] flex justify-center items-center gap-10 text-[#15364A]">
      ...
      <div className="w-[50%] flex flex-col justify-start items-center">
        <div className="w-full flex flex-col gap-4">
          ...
          <p className="w-fit text-xl font-medium pb-5 pr-48 border-b-2 border-[#15364a2c]">
            Criação e ativações em <span className="font-bold">4 minutos.</span>
          </p>
        </div>

        <div className="w-full flex items-center mt-4 gap-3">
          <Link href={links.demonstracao}>
            <button className={styleButton}>Ver Demonstração</button>
          </Link>
          <Image
            src="/selo_RD.png"
            alt="Selo RD Station"
